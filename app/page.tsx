...
export default function Home() {
  const { todos, loading, error, addTodo, updateTodo, deleteTodo, refetch } =
    useTodos();

  const handleAddTodo = async (
    todoData: Parameters<typeof addTodo>[0]
  ): Promise<boolean> => {
  ...
  const handleUpdateTodo = async (
    id: string,
    updateData: Parameters<typeof updateTodo>[1]
  ): Promise<boolean> => {
    ...
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">A simple todo app</p>
        </div>
